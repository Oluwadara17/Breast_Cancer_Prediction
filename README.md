# Title: Breast_Cancer_Prediction
This project is focused on utilising multiple machine learning algorithms to diagnose breast cancer based on various features.
...
# Result 
The best model for the project is Random Forest, having an accuracy of 95.7% while SVM has 95.2%.

# Reference
Brian Jalaian. (2023). Breast Cancer Classification: MAP 6990 - Fall 2023
https://kaggle.com/competitions/breast-cancer-classification-map-6990-fall-2023
